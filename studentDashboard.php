...
$fullname=$Fname." ".$Lname;
 ...
 $ProfileImage=$conn->query("SELECT * FROM StudentTable WHERE StudentEmailId='$studentEmail'");
        if($ProfileImage){
        while($row=$ProfileImage -> fetch_assoc()){
        // $userName =$row["AdminUserName"];
                $profileImage = 'studentProfile/'.$row["profileImage"];
    ...
    <div class="view-account">
        <section class="module">
            <div class="module-inner">
                <div class="side-bar">
                    <div class="user-info">
                        <img class="img-profile img-circle img-responsive center-block" src="<?php echo $profileImage?>" alt="">
                    ...
                    <nav class="side-menu">
                        <ul class="nav">
                            ...
                            <li class=""><a href="videochat.html"><span class="fa fa-credit-card"></span> Virtual chat room</a></li>
                            <li><a href="studentChatroom.php"><span class="fa fa-envelope"></span>Chatroom</a></li>

                            <li><a href="c-grade1-1.html"><span class="fa fa-th"></span>Curriculum</a></li>
